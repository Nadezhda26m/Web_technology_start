...
alert(`Цельсий: ${(num).toFixed(2)}, Фаренгейт: ${(convertTemp(num)).toFixed(2)}`);
console.log((num).toFixed(3));


function convertTemp(numCelsius) {
    return ((9 / 5) * numCelsius + 32);
}

/* Задание 1
Необходимо создать html-страницу с названием 1.html, в которой подключить 
