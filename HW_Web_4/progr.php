...
$experience = [
  [
      ...
      'start' => 'Jan 2015',
      'end' => 'Current',
      'details' => 'Lorem ipsum dolor sit amet. Praesentium magnam consectetur vel in deserunt aspernatur est reprehenderit
  ...
  [
      ...
      'start' => 'Mar 2012',
      'end' => 'Dec 2014',
      'details' => 'Consectetur adipisicing elit. Praesentium magnam consectetur vel in deserunt aspernatur est reprehenderit
            sunt hic. Nulla tempora soluta ea et odio, unde doloremque repellendus iure, iste.',
  ],
  [
            ...
            <div class="w3-container">
              ...
              <?php if ($experience[$i]['end'] == 'Current'): ?>
                  <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i>
                    <?php echo $experience[$i]['start']; ?> - <span class="w3-tag w3-teal w3-round">
                    <?php echo $experience[$i]['end']; ?></span>
                  </h6>
              <?php else: ?>
                  <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i>
                    <?php echo $experience[$i]['start']; ?> - <?php echo $experience[$i]['end']; ?></h6>
              <?php endif; ?>
              <p><?php echo $experience[$i]['details']; ?></p>
              <hr>
            </div>
          <?php endfor;?>
        </div>
